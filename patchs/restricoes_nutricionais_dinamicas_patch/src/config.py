...
# As restrições não são mais definidas por uma lista fixa. A tela de formulação
# monta dinamicamente as linhas a partir dos nutrientes disponíveis nos
# ingredientes selecionados. ``NUTRIENT_CODES`` permanece como o catálogo de
# nutrientes reconhecidos pelo sistema e sua ordem canônica de exibição.
