...
def render(repository: Repository, user: User) -> None:
    ...
    if full_items.empty:
        ...
        # O valor retornado é o estado corrente do editor. Ele alimenta o solver
        # e a sessão, mas NÃO substitui ITEMS_EDITOR_BASE_KEY. Assim, o widget
        # continua recebendo a mesma base entre reruns causados por Enter/Tab.
    ...
    # Mantém a versão corrente para cálculo/salvamento, sem realimentar o editor
    # com ela na próxima execução. A base visual permanece estável.
